...
This extension will take all of your Auth0 logs and export them to Logentries.
...
$ wt cron schedule \
    ...
    --secret LOGENTRIES_TOKEN="LOGENTRIES_TOKEN" \
    "*/5 * * * *" \
    build/bundle.js
```
...
Go to [Logentries](https://www.logentries.com) account to inspect logs
