...
config.output.filename = 'auth0-logs-to-logentries.ui.' + project.version + '.js';
...
config.plugins = config.plugins.concat([
  ...
  new ExtractTextPlugin('auth0-logs-to-logentries.ui.' + project.version + '.css', {
    allChunks: true
  }),

  // Separate the vender in a different file.
  new webpack.optimize.CommonsChunkPlugin('vendors', 'auth0-logs-to-logentries.ui.vendors.' + project.version + '.js'),
